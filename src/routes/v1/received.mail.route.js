...
router.route('/').get(auth('getMyEmails'), validate(mailValidation.getEmails), mailController.getEmails);
 ...
 *     description: retrieve user email.
 *     tags: [Mail]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *                   type: array
 *                   items:
 *                     $ref: '#/components/schemas/ReceivedEmails'
 *                 page:
 *                   type: integer
 *                   example: 1
 *                 limit:
